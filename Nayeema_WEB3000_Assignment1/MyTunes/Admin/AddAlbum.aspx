<%@ Page Title="Add Album" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="~/Admin/AddAlbum.aspx.cs" Inherits="MyTunes.Admin.AddAlbum" %>
...
<h1>Administration</h1>
    ...
    <table>
        <tr>
           <td><asp:Label ID="LabelAddName" runat="server">Name:</asp:Label></td>
            <td>
                <asp:TextBox ID="AddAlbumName" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Text="* Album name required." ControlToValidate="AddAlbumName" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="LabelAdArtist" runat="server">Artist:</asp:Label></td>
            <td>
                <asp:DropDownList ID="DropDownArtist" runat="server" 
    ...
    <p></p>
    <p></p>
    <asp:Button ID="AddAlbumButton" runat="server" Text="Add Album" OnClick="AddAlbumButton_Click"  CausesValidation="true"/>

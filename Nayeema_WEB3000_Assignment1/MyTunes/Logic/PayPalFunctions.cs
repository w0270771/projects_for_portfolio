...
public class NVPAPICaller
{
    ...
    public string APIUsername = "nnayeemamustaril_api1.yahoo.com";
    private string APIPassword = "TADLAXC447P9FQ9A";
    private string APISignature = "AFcWxV21C7fd0v3bYYYRCpSSRl31AogZoYKepMNvenmDGXG8d0z5-0SM";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "MyTunes Sample Application";
